...
**เป้าหมายที่ 2: มีกิจกรรมฝึกอบรมและสร้างความตระหน���กอย่างเป็นรูปธรรม**
...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **คำศัพท์ขององค์กร**               | อภิปรายคำศัพท์ที่ใช้ใน CRR ซึ่���อาจก่อให้เกิดการพูดคุยเกี่ยวกับคำศัพท์เฉพาะที่ใช้ในบริบทขององค์กรนั้น ๆ                                                                                                                                                             |
...
- **���ังไม่ปฏิบัติ (not performed):** เมื่อตอบคำถามว่า “Incomplete” (สีเหลือง), “No” (สีแดง) หรือ “Not Answered” (สีเทา)
...
เอกสารฉบับนี้อธิบายถึง **สถาปัตยกรรมของ Cyber Resilience Review (CRR)** พร้อมทั้งรายละเอ��ยดของ **10 โดเมนหลักของ CRR** และ **6 ระดับตัวชี้วัดวุฒิภาวะ (Maturity Indicator Levels - MILs)**
...
| data leak                                     | การเปิดเผยข้อ���ูลโดยเจตนาหรือไม่เจตนาไปยังสภาพแวดล้อมที่ไม่น่าเชื่อถือ                                                                                                           | NIST SP 800-53                  |
