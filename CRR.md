...
2. มีการระบุทักษะที่จำเป็นสำหรับบทบาทเฉพาะ (เช่น ผู้ดูแลระบบ ช่างเทคนิค ฯลฯ) ที่เกี่ยวข้องกับบริการที่สำคัญ
3. มีการระบุช่องว่างด้านทักษะของบุคลากรที่รับผิดชอบความมั่นคงปลอดภัยทางไซเบอร์
4. มีการระบุความต้องการในการฝึกอบรม

**เป้าหมายที่ 2: มีกิจกรรมฝึกอบรมและสร้างความตระหนักอย่างเป็นรูปธรรม**

1. มีกิจกรรมสร้างความตระหนักด้านไซเบอร์สำหรับบริการที่สำคัญ
2. มีกิจกรรมฝึกอบรมด้านไซเบอร์สำหรับบริการที่สำคัญ
...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **คำศัพท์ขององค์กร**           | อภิปรายคำศัพท์ที่ใช้ใน CRR ซึ่งอาจก่อให้เกิดการพูดคุยเกี่ยวกับคำศัพท์เฉพาะที่ใช้ในบริบทขององค์กรนั้น ๆ                                                                                                                                                               |
...
1. แนวปฏิบัติ (Practices) จะถือว่า:

   * "ดำเนินการแล้ว (Yes)" หากมีการดำเนินการตามแนวปฏิบัติครบถ้วน
   * "ดำเนินการไม่สมบูรณ์ (Incomplete)" หากดำเนินการเพียงบางส่วน
   * "ไม่ได้ดำเนินการ (No)" หากไม่มีการดำเนินการเลย

2. เป้าหมาย (Goal) จะถือว่าบรรลุผลได้ ก็ต่อเมื่อแนวปฏิบัติทั้งหมดในเป้าหมายนั้นได้รับการดำเนินการ (ตอบ “Yes” ทั้งหมด)

3. โดเมนจะถือว่าบรรลุระดับ MIL1 ได้ ก็ต่อเมื่อเป้าหมายทั้งหมดในโดเมนนั้นได้รับการบรรลุผล

4. โดเมนจะสามารถบรรลุระดับ MIL ที่สูงขึ้น (MIL2 ถึง MIL5) ได้ ก็ต่อเมื่อคำถามในแต่ละระดับ MIL นั้น ๆ ได้รับคำตอบว่า "Yes" ครบทุกข้อ
...
แต่ละแนวทางปฏิบัติ (practice) ภายในแต่ละโดเมนจะได้รับคะแนนตามเกณฑ์ต่อไปนี้:

- **ปฏิบัติแล้ว (performed):** เมื่อตอบคำถามด้วย “Yes” (สีเขียว)
- **ยังไม่ปฏิบัติ (not performed):** เมื่อตอบคำถามว่า “Incomplete” (สีเหลือง), “No” (สีแดง) หรือ “Not Answered” (สีเทา)
- **หากเป็น "Not Answered" (สีเทา):** หมายถึงคำถามถูกเว้นว่างไว้ และจะถือว่ามีค่าเท่ากับ “No”
